...
export default function HomeContent() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            <AnimatedSection>
              ...
              <motion.p
                variants={fadeUp}
                className="text-text-muted text-base md:text-lg max-w-xl mt-4 leading-relaxed font-medium"
              >
                Premium websites for service businesses, startups and independent brands.
              </motion.p>
      ...
      {/* ─── RELATED RESOURCES ─── */}
      <AnimatedSection className="py-20 max-w-7xl mx-auto px-6">
        <motion.p variants={fadeUp} className="font-[family-name:var(--font-mono)] text-xs text-maroon uppercase tracking-widest mb-4">Resources</motion.p>
        <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold mb-8 text-text-primary">Useful guides and checklists</motion.h2>
        <div className="grid md:grid-cols-3 gap-4">
          <Link href="/resources/website-cost-india" className="bg-white border border-border-hard p-6 hover:-translate-y-1 hover:shadow-hard-hover transition-all duration-200 group">
            <h3 className="text-lg font-bold text-text-primary group-hover:text-maroon transition-colors">How Much Does a Business Website Cost in India?</h3>
            <p className="text-text-muted text-sm mt-2">A practical breakdown of website design costs, from starter sites to premium builds.</p>
          </Link>
          <Link href="/resources/nextjs-vs-wordpress" className="bg-white border border-border-hard p-6 hover:-translate-y-1 hover:shadow-hard-hover transition-all duration-200 group">
            <h3 className="text-lg font-bold text-text-primary group-hover:text-maroon transition-colors">Next.js vs WordPress for a Business Website</h3>
            <p className="text-text-muted text-sm mt-2">When to choose a modern framework over a CMS for your business site.</p>
          </Link>
          <Link href="/resources/website-redesign-checklist" className="bg-white border border-border-hard p-6 hover:-translate-y-1 hover:shadow-hard-hover transition-all duration-200 group">
            <h3 className="text-lg font-bold text-text-primary group-hover:text-maroon transition-colors">Website Redesign Checklist</h3>
            <p className="text-text-muted text-sm mt-2">A step-by-step checklist for planning and executing a website redesign.</p>
          </Link>
        </div>
      </AnimatedSection>
