...
const projects = [
  ...
  { num: '03', category: 'E-commerce · Fashion Retail', title: 'Driftwear Studio', desc: 'An editorial e-commerce experience for relaxed, breathable clothing designed for Indian warm-weather living. Features a full shopping flow from product browsing through cart to checkout, persistent cart state, category filtering, and Razorpay payment integration.', stack: 'Next.js · TypeScript · Zustand · Tailwind CSS', live: 'https://driftwear-ecommerce.vercel.app/', caseStudy: '/work/driftwear-ecommerce', github: 'https://github.com/witejackel-eng/driftwear-ecommerce', outcome: 'Full e-commerce flow with editorial design and persistent cart experience', role: 'Frontend, UI Design, E-commerce Architecture' },
  { num: '04', category: 'Real Estate · Luxury Advisory', title: 'Real Estate Atelier', desc: 'A premium real estate advisory website for considered homes across India. Cinematic editorial design with curated property collections, custom filtering by city and type, immersive property detail pages, seller advisory, and a branded luxury experience with custom cursor and page loader.', stack: 'Next.js · TypeScript · GSAP · Framer Motion · Tailwind CSS', live: 'https://real-estate-atelier.vercel.app/', caseStudy: '/work/real-estate-atelier', github: 'https://github.com/witejackel-eng/real-estate-atelier', outcome: 'Cinematic luxury real estate platform with curated property discovery', role: 'Frontend, UI Design, Animations, Form Systems' },
];
